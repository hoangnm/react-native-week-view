...
<CodeDemo
  imgSrc={require('./img/custom-event-component.png').default}
>
...
<CodeDemo imgSrc={require('./img/custom-today-component.png').default}>
...
<CodeDemo imgSrc={require('./img/custom-day-component.png').default}>
...
<CodeDemo imgSrc={require('./img/custom-refresh-component.png').default}>
