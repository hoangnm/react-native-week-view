...
<CodeDemo imgSrc={require('./img/minimal.png').default}>
...
<CodeDemo imgSrc={require('./img/press-alerts.gif').default}>
...
|:---:|:---:|:---:|
| ![blue](./img/styles/blue.png) | ![green](./img/styles/green.png) | ![dark](./img/styles/dark.png) |
