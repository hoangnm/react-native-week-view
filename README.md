...
| `dragEventConfig`                                                            | _{afterLongPressDuration: milliseconds}_ \| _null_             | `{afterLongPressDuration: 0}`       | If provided, events are draggable after long pressed for some time. **Requires rn-gesture-handler v2.6.0 or higher.** Disables the `onLongPress` callback.                                                                                                                                                                                                                                                                                                                          |
...
| `editingEvent`                                                               | _Number_\| _String_ \| null_                                   | `null`                              | id indicating the event currently being edited.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `editEventConfig`                                                            | _{bottom: bool, top: bool, left: bool, right: bool}_ \| _null_ | `{bottom: true}`                    | Sides allowed to be edited.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
