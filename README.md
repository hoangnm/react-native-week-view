...
| `dragEventConfig`                                                            | _{afterLongPressDuration: milliseconds}_                     | `{afterLongPressDuration: 0}`       | If provided, events are draggable after long pressed for some time. **Requires rn-gesture-handler v2.6.0 or higher.** Disables the `onLongPress` callback.                                                                                                                                                                                                                                                                                                                          |
